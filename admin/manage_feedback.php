...
$data = Paging('Feedback',$item_per_page,"SELECT * FROM Feedback ORDER BY TIME");
?>
<div class="top-bar">
...
<div class="table">
                    <table class="listing" cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                            <td><span style="font-weight:bold;">Ý kiển phản hồi #<?echo $row['ID']?></span> - <?echo $row['NAME']?> - [ <?echo date("d/m/Y",$row['TIME'])?> ]</td>
                       
                            <td class="btn"><a href='?page=reply_feedback&id=<?echo $row['ID'];?>'><img src="img/email_edit.png" width="16" height="16" alt="" /></a></td>
                         
                            <td class="btn"><a href="#" onclick="confirm_delete('feedback',<?echo $row['ID']; ?>)"><img src="img/hr.gif" width="16" height="16" alt="Delete" /></a></td>
                        </tr>
 <? } ?>
                        <tr>
