...
$data = Paging('Brand',$item_per_page);
?>
<div class="top-bar">
                    <h1>Thêm hệ điều hành</h1>
</div>
<br />
<form name="add_brand" action="?page=brand_query&action=add" method="POST" >
<div class="table">
<table class="listing form" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td width="50%">
      <input name="BRANDNAME" type="text" size="30" />
    </td>
  </tr>
    <tr>
    <td>Miêu tả</td>
    <td>
      <input name="BRANDDESC" type="text" size="30" />
    </td>
  </tr>
  <tr>
...
<div class="table">
                    <table class="listing" cellpadding="0" cellspacing="0">
                        <tr>
                            <th colspan="4" class="full">Danh sách nhà sản xuất | Hiển thị: 
                        ...
                        <tr>
                            <td><span style="font-weight:bold;"><?echo $row['BRANDNAME']?></span> - <?echo $row['BRANDDESC']?></td>
                       
                            <td><a href='?page=update_brand&id=<?echo $row['ID'];?>'><img src="img/edit-icon.gif" width="16" height="16" alt="" /></a></td>
                            <td class="btn"><a href="#" onclick="confirm_delete('brand',<?echo $row['ID']; ?>)"><img src="img/hr.gif" width="16" height="16" alt="Delete" /></a></td>
                        </tr>
 <? } ?>
                        <tr>
