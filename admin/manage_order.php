...
$data = Paging('`Order`',$item_per_page);
?>
<div class="top-bar">
...
<div class="table">
                    <table class="listing" cellpadding="0" cellspacing="0">
                        <tr>
                            <th colspan="4" class="full">Danh sách đơn đặt hàng | Hiển thị: 
                            ...
                            <?echo mysql_num_rows($data['result']);?>
                            </th>
                        </tr>
                        <?php while($row = mysql_fetch_array($data['result'])){ 
                          ...
                          ?>
                        <tr>
                            <td><span style="font-weight:bold;"><a href='?page=view_order&id=<?echo $row['ID']?>'>Đơn hàng #<?echo $row['ID']?></a></span> - <?echo '[ '.$time.' ]'?> - <span style="font-weight:bold;"><?echo $row['STATUS']?></span></td>
                       
                            <td class="btn"></td>
                      
                            <td class="btn"><a href="#" onclick="confirm_delete('order',<?echo $row['ID']; ?>)"><img src="img/hr.gif" width="16" height="16" alt="Delete" /></a></td>
                        </tr>
 <? } ?>
                        <tr>
